 ...
 * @LastEditors: zhaobo
 * @LastEditTime: 2021-05-10 15:52:09
-->
<template>
  <div class="submenu-wrapper">
    <div class="submenu-item" :class="{'active': currentActive === item.name}" v-for="item in subMenuList" :key="item.name" @click="currentActive = item.name">
